...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("What layers the character uses as ground. PLAYER MUST BE AT THE DIFFERENT LAYER")]
    ...
    private void GroundedCheck()
    {
        ...
        // PLAYER MUST BE AT THE DIFFERENT LAYER
    ...
    private void CameraRotation()
    {
        ...
        if (look.sqrMagnitude >= cameraRotationThreshold)
        {
            ...
            cameraPitch += look.y * RotationSpeed;

            // clamp our pitch rotation
            cameraPitch = Mathf.Clamp(cameraPitch, BottomClamp, TopClamp);

            // Update camera pitch
            mainCamera.transform.localRotation = Quaternion.Euler(cameraPitch, 0.0f, 0.0f);
    ...
    private void Move()
    {
        ...
        if (currentHorizontalSpeed < targetSpeed - speedOffset || currentHorizontalSpeed > targetSpeed + speedOffset)
        {
            ...
            speed = Mathf.Lerp(currentHorizontalSpeed, targetSpeed * inputMagnitude, Time.deltaTime * AccelerationFactor);
